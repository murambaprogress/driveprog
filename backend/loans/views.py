...
DriveCash Admin Team
    ...
    def upload_document(self, request, pk=None):
        ...
        # Prevent uploading to submitted applications unless admin
        if not application.is_draft and not (hasattr(request.user, 'user_type') and request.user.user_type == 'admin'):
            return Response(
        ...
        # Map frontend field names to backend photo fields
        field_mapping = {
        ...
        backend_field = field_mapping.get(field_name, None)
